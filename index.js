...
let firstAnswer  = window.prompt('Do you head left or right?')
    ...
    Do you follow it, or continue on your path?`)
        ...
        let answer = window.prompt('You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven.')
            if(answer === stay){
                let answer = window.prompt('You live happily amongst the cats for the rest of your days.')
            }
            else if(answer == Spread_the_word){
                let answer = window.prompt('After leaving the cat colony, you are never able to find it again; without proof, no one believes your story, which passes into legend nonetheless.')
            }
