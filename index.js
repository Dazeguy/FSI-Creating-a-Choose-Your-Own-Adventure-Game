    ...
    if(firstAnswer === 'left'){
        ...
        Do you follow it, or continue on your path?`)
            if(secondAnswer === 'follow'){
                ...
                let followAnswer = window.prompt('Do you stay or spread the word?')
                    if (followAnswer === 'stay'){ // this is the finaly answer to left side stay \\
                       window.alert('You live happily amongst the cats for the rest of your days.')
                    }
            else if(followAnswer === 'spread'){
